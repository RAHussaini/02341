...
public class PetrinetPaletteFactory {
	...
	*/
	private ToolEntry createPlace2CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(Messages.Place2CreationTool_title,
				Messages.Place2CreationTool_desc, Collections.singletonList(PetrinetElementTypes.Place_2001));
